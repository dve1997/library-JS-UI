...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.get = async function (url, typeResp = "json") {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.post = async function (url, data, typeResp = "text") {
  let res = await fetch(url, {
    method: "POST",
    body: data
  });
